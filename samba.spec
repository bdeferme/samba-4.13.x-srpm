...
# Rolled back from rawhide for el7
...
The python%{python3_pkgversion}-%{name}-devel package contains the Python 3 defel files.
...
%if 0%{?el7}
# RHEL 7 blows up on LANG=C.UTF8
...
# Unforrunately, it is not consistently defined except for rawhide
...
%changelog
* Sun Feb 7 2021 Nico Kadel-Garcia <nkadel@gmail.com> - 4.14.0rc2-0.1
- Clear excess whitespace and contractions of .spec file
- Reset winexe to avoid EL7
- Reset NFS dependencies for EL7
- Reset iso8601 dependencies for EL7
- Use python3_pkgversion for EL7
- Enable dc for EL
